  ...
  try {
    ...
    const processedPolls = polls.map(poll => {
      ...
      const outputPoll = {
        ...
        supportingFacts: poll.supporting_facts,
...
app.post('/api/polls', async (req, res) => {
  const { adminName, adminMobile, question, supportingFacts, options } = req.body;
  ...
  try {
    const newPoll = {
      ...
      supporting_facts: supportingFacts ? supportingFacts.trim() : null,
